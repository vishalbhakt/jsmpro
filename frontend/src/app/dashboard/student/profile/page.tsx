...
import { User, Mail, Phone, MapPin, Save, Shield, Loader2, Camera } from "lucide-react";
  ...
  return (
    <DashboardLayout>
      <div className="max-w-4xl space-y-10 pb-20">
        <div>
          <h1 className="text-4xl font-black text-navy tracking-tight">Personal Identity</h1>
          <p className="text-slate-500 font-medium mt-1">Manage your student profile and contact information.</p>
        </div>
        ...
        <form onSubmit={handleUpdate} className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          <div className="lg:col-span-1 space-y-6">
            <div className="bg-white rounded-[3rem] border border-navy/5 p-10 text-center shadow-sm relative overflow-hidden group">
              ...
              <p className="text-[10px] font-black uppercase tracking-widest text-gold mt-1">{profile.role}</p>
              <div className="mt-6 pt-6 border-t border-navy/5 grid grid-cols-2 gap-4">
                 <div>
                    <div className="text-[10px] font-black text-slate-300 uppercase">Class</div>
                    <div className="font-bold text-navy text-sm">{profile.student_profile?.course_name || 'N/A'}</div>
                 </div>
                 <div>
                    <div className="text-[10px] font-black text-slate-300 uppercase">Roll No.</div>
                    <div className="font-bold text-navy text-sm">{profile.student_profile?.roll_number || 'N/A'}</div>
                 </div>
              </div>
            </div>
            ...
            <div className="bg-navy rounded-[2.5rem] p-8 text-white shadow-xl relative overflow-hidden">
              ...
              <div className="flex items-center gap-2 relative z-10">
                ...
                <span className="text-sm font-bold text-emerald-400">Account Active</span>
              </div>
