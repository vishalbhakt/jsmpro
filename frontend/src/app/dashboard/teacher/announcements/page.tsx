      ...
      <div className="space-y-10 pb-20">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div>
            ...
            <p className="text-slate-500 font-medium mt-1">Communicate with students and parents across your assigned academic units.</p>
          </div>
          <button 
               ...
               >
                  <div className="flex-1 space-y-8">
                     <div>
                        ...
                        <p className="text-slate-400 font-medium mt-1 italic">Publish important updates or reminders to your students.</p>
                     </div>
